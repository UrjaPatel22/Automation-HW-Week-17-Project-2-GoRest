...
public void test002(){
    ...
    System.out.println("Extract all  name is " +name);
}
...
//4. Extract the names of all object whose status = inactive
    ...
    public void test004(){
        ...
        System.out.println("Name of all the object where status is inactive : " +name);
    }
...
@Test
public void test010(){
    String email = response.extract().path("find{it.name=='Krishnadas Chaturvedi'}.email");
    System.out.println("email of the object where name =Krishnadas Chaturvedi" +email);
}
